...
// Research Survey Pages
const PreSurvey = lazy(() => import('./pages/survey/PreSurvey'));
const PostSurvey = lazy(() => import('./pages/survey/PostSurvey'));
...
const SOSManagement = lazy(() => import('./pages/admin/SOSManagement'));
