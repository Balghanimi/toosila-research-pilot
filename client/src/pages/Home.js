...
const Home = () => {
  ...
  const [pickupCoords, setPickupCoords] = useState({ lat: null, lng: null, address: null });
  const [dropCoords, setDropCoords] = useState({ lat: null, lng: null, address: null });
    ...
    if (mode === 'find') {
      ...
      try {
        ...
        const offerData = {
          ...
          fromAddress: pickupCoords.address,
  ...
  const clearForm = () => {
    ...
    setPickupCoords({ lat: null, lng: null, address: null });
    setDropCoords({ lat: null, lng: null, address: null });
        ...
        <div className={styles.locationContainer}>
          ...
          <div className={styles.locationRow}>
            ...
            <div className={styles.locationInputWrapper}>
              <LocationPicker
                city={pickupLocation}
                onCityChange={setPickupLocation}
                lat={pickupCoords.lat}
                lng={pickupCoords.lng}
                address={pickupCoords.address}
                onLocationChange={setPickupCoords}
          ...
          <div className={styles.locationRow}>
            ...
            <div className={styles.locationInputWrapper}>
              <LocationPicker
                city={dropLocation}
                onCityChange={setDropLocation}
                lat={dropCoords.lat}
                lng={dropCoords.lng}
                address={dropCoords.address}
                onLocationChange={setDropCoords}
                cities={availableCities}
