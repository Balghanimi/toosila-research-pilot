...
class Demand {
  ...
  static async create(demandData) {
    ...
    const result = await query(
      `INSERT INTO demands (passenger_id, from_city, to_city, earliest_time, latest_time, seats, budget_max, is_ladies_only, is_active, from_lat, from_lng, to_lat, to_lng, from_address, to_address)
  ...
  static async findByPassengerId(passengerId, page = 1, limit = 10) {
    ...
    const countResult = await query('SELECT COUNT(*) FROM demands WHERE passenger_id = $1', [
      passengerId,
    ]);
