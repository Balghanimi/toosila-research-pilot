...
const registerLimiter = rateLimit({
  ...
  message: {
    ...
    message: isDev
      ? 'Too many registration attempts (dev mode)'
...
const passwordResetLimiter = rateLimit({
  ...
  message: {
    ...
    message: isDev
      ? 'Too many password reset attempts (dev mode)'
...
const createOfferLimiter = rateLimit({
  ...
  message: {
    ...
    message: isDev
      ? 'Too many offers (dev mode)'
      : 'Too many offers created. Please try again later.',
    retryAfter: isDev ? 300 : 3600,
  },
  standardHeaders: true,
  legacyHeaders: false,
...
const createBookingLimiter = rateLimit({
  ...
  message: {
    ...
    message: isDev
      ? 'Too many bookings (dev mode)'
      : 'Too many bookings created. Please try again later.',
    retryAfter: isDev ? 300 : 3600,
  },
  standardHeaders: true,
  legacyHeaders: false,
