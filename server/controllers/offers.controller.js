...
const createOffer = asyncHandler(async (req, res) => {
  ...
  const modResult = await moderationAgent.analyzeOffer({
...
const updateOffer = asyncHandler(async (req, res) => {
  ...
  await auditLog('offers', id, 'update', oldData, updatedOffer.toJSON(), req.user.id, req.ip);
...
const deactivateOffer = asyncHandler(async (req, res) => {
  ...
  await auditLog('offers', id, 'delete', oldData, { is_active: false }, req.user.id, req.ip);
