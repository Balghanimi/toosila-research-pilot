...
app.use('/api/emergency', noCache, emergencyRoutes); // Emergency contacts routes
app.use('/api/sos', noCache, sosRoutes); // SOS alert routes
app.use('/api/survey', noCache, surveyRoutes); // Research pilot surveys
app.use('/api/analytics', noCache, analyticsRoutes); // Research analytics events
