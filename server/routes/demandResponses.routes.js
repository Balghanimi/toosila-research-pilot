 ...
 * للسائقين فقط
 */
router.post('/', authenticateToken, checkDriver, ...validateCreateResponse, createDemandResponse);
 ...
 */
router.get('/batch', authenticateToken, getResponsesBatch);
 ...
 * ملاحظة: يجب أن يكون هذا المسار قبل /:id لتجنب التعارض
 */
router.get('/my-responses', authenticateToken, checkDriver, getMyResponses);
 ...
 */
router.get('/demand/:demandId', authenticateToken, getResponsesByDemand);
 ...
 */
router.patch('/:id/status', authenticateToken, ...validateUpdateStatus, updateResponseStatus);
 ...
 */
router.delete('/:id', authenticateToken, checkDriver, deleteDemandResponse);
