...
// File: server\scripts\run-demand-responses-migration.js
// Generated: 2025-11-10T14:33:54.320Z

const run_demand_responses_migration = require('../../scripts/run-demand-responses-migration.js');

describe('run-demand-responses-migration', () => {
  let req, res, next;
