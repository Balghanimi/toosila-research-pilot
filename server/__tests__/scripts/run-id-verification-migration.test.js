...
// File: server\scripts\run-id-verification-migration.js
// Generated: 2025-11-10T14:33:54.563Z

const run_id_verification_migration = require('../../scripts/run-id-verification-migration.js');

describe('run-id-verification-migration', () => {
  let req, res, next;
