...
class Offer {
  ...
  static async create(offerData) {
    const { driverId, fromCity, toCity, departureTime, seats, price, isLadiesOnly = false } = offerData;
    const result = await query(
      `INSERT INTO offers (driver_id, from_city, to_city, departure_time, seats, price, is_ladies_only, is_active)
       VALUES ($1, $2, $3, $4, $5, $6, $7, true)
       RETURNING *`,
      [driverId, fromCity, toCity, departureTime, seats, price, isLadiesOnly]
    );
  ...
  static async findById(id, currentUserId = null) {
    ...
    if (currentUserId) {
      ...
      sql = `SELECT o.*, u.name, u.gender, u.rating_avg, u.rating_count,
       ...
       WHERE o.id = $1
       GROUP BY o.id, u.name, u.gender, u.rating_avg, u.rating_count, ub.id, ub.status`;
      ...
      sql = `SELECT o.*, u.name, u.gender, u.rating_avg, u.rating_count,
       ...
       LEFT JOIN bookings b ON o.id = b.offer_id
       WHERE o.id = $1
       GROUP BY o.id, u.name, u.gender, u.rating_avg, u.rating_count`;
      params = [id];
    }
  ...
  static async findAll(page = 1, limit = 10, filters = {}, currentUserId = null) {
    ...
    const result = await query(
      `SELECT o.*, u.name, u.gender, u.rating_avg, u.rating_count,
       ...
       ${whereClause}
       GROUP BY o.id, u.name, u.gender, u.rating_avg, u.rating_count${userBookingGroupBy}
